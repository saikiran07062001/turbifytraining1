...
<input type="number" name="trainno" placeholder="enter train number" required="true">
<input type="submit" value="search" placeholder="enter train number here">
</form>
<h3>Your journey our safety,Book your tickets here</h3><button><a href="https://www.irctc.co.in/nget/">IRCTC</a></button><br><br>
